...
<head>
    ...
    <h2 class="text-center m-4 course-p">Mont Kwel Thae</h2>
    
   <div class="info">
    <h3 class="text-success course-p">Ingredients</h3>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Rice flour - 1 cup = 16 tablespoons</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Betel leaves added to (Lime stone) - Half a teaspoon</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Water - 1 liter</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>A palm tree that has been left to ripen Syrup - 8 tablespoons</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Salt - a quarter teaspoon</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Oil - 2 tablespoons</p>
    
</div>

    <!-- instruction section -->
    <div class="bg-tky-img-container">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card recipe-card p-4">
                <div class="card-body text-center">
                    <h2 class="card-title mb-3">Mont Kwel Thae</h2>
                    <hr class="my-4">
                    <h3 class="card-subtitle mb-4 ">Instructions</h3>
                    <ol class="list-unstyled text-start">
                        <li>1.Mash lime in 1 liter of water and let it sit for at least 8 hours.</li>
                        <li>2. Carefully pour off 750 ml of the clear lime juice,leaving any sediment behind.</li>
                        <li>3. In a bowl, mix green rice flour, 750 ml lime juice, salt, palm sugar, and oil.</li>
                        <li>4.Pour the mixture into a non-stick pot and heat, stirring continuously for 15 minutes until it thickens.</li>
                        <li>5.  Once thickened, add buttered bread, place on a cooling rack,and let it cool completely.Slice it and sprinkle with sesame seeds.</li>
                    </ol>
                </div>
            </div>
        </div>
