...
<head>
    ...
    <h2 class="text-center m-4 course-p">Kout Nyin Shwe Tha Min</h2>
    
   <div class="info">
    <h3 class="text-success course-p">Ingredients</h3>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Rice - 1 glutinous (soaked overnight)</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Palm -10 palm kernels</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Coconut (as needed)</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Salt - 1 tablespoon (teaspoon)</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Butter- 1 tablespoon (teaspoon,If you don't have butter, add plain oil)</p>
    ...
    <!-- instruction section -->
    <div class="bg-shm-img-container">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card recipe-card p-4">
                <div class="card-body text-center">
                    <h2 class="card-title mb-3">Kout Nyin Shwe Tha Min</h2>
                    <hr class="my-4">
                    <h3 class="card-subtitle mb-4 ">Instructions</h3>
                    <ol class="list-unstyled text-start">
                        <li>1.Cook the glutinous rice in a pot with 1 cup of water and 1 cup of oil.</li>
                        <li>2. Boil the palm sugar and strain it, then add salt and bring to a boil.When it thickens, add the cooked glutinous rice.</li>
                        <li>3. Add 1 tablespoon of butter or cooking oil. When the water has evaporated and the rice has thickened, pour it into a greased pan. </li>
                        <li>4..Press the surface and press. When the glutinous rice has cooled, it is ready to be sliced. </li>
                        <li>5. Sprinkle grated coconut on top, you can have a very delicious golden rice.</li>
                    </ol>
                </div>
            </div>
        </div>
