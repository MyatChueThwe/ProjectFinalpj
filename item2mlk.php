...
<head>
    ...
    <h2 class="text-center m-4 course-p">Mont Let Kauk (Fried sticky glutinous rings with jaggery syrup)</h2>
    
   <div class="info">
    <h3 class="text-success course-p">Ingredients</h3>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>1 cup glutinous rice flour</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>1/4cup sticky rice flour</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>1/4tsp baking soda</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>1/4 teaspoon salt</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>1/2 cup Water</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Required a little Jaggery</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Required a little Sesame Seeds</p>
</div>

    

    <!-- instruction section -->
    <div class="bg-mlk-img-container">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card recipe-card p-4">
                <div class="card-body text-center">
                    <h2 class="card-title mb-3"> Mont Let Kauk</h2>
                    <hr class="my-4">
                    <h3 class="card-subtitle mb-4 ">Instructions</h3>
                    <ol class="list-unstyled text-start">
                        <li>1. In a bowl, combine 1 cup glutinous rice flour, ¼ cup rice flour, ¼ tsp baking soda, and ¼ tsp salt. Mix well, then gradually add ½ cup water and knead into a soft dough.</li>
                        <li>2. Wash jaggery candy with warm water, then boil in hot water until it forms a smooth, thick paste. </li>
                        <li>3. Heat a good amount of oil in a kadai. Fry the doughnuts until evenly golden brown on both sides, the outer parts are well-cooked.</li>
                        <li>4. Remove fried doughnuts and place them on a kitchen napkin to absorb excess oil. Serve hot with the jaggery sauce. </li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="see-more">
        <button class="see-more-btn"><a href="./userlogin.html" class="see-more-text text-decoration-none">More Details</a></button>
       </div>
        ...
        <div class="container px-4">
         <div class="row">
           <div class="col col-lg-4">
            <img src="./sticker-chef-cuisine-cook-wall-bon-apetit-4c773f87bd0369fcb953c826ee8888f2.png" alt="" width="100px" height="90px" class="mt-5">
           </div>
           <div class="col">
