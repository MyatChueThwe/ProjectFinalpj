...
<head>
    ...
    <h2 class="text-center m-4 course-p">Mont Phet Htoke(Htapana Htoke)</h2>
    
   <div class="info">
    <h3 class="text-success course-p">Ingredients</h3>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Sticky Rice Powder - 1 pinch </p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Rice Flour   - 1 tablespoon</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Mix a little salt with water.</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Coconut - Half a grated coconut</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Sugar - 3 Tbs sugar</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Coconut Milk - 3 Tbs coconut milk</p>
    ...
    <!-- instruction section -->
    <div class="bg-mph-img-container">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card recipe-card p-4">
                <div class="card-body text-center">
                    <h2 class="card-title mb-3"> Mont Phet Htoke</h2>
                    <hr class="my-4">
                    <h3 class="card-subtitle mb-4 ">Instructions</h3>
                    <ol class="list-unstyled text-start">
                        <li>1. Soak the coconut until the water is drained and dry.</li>
                        <li>2. Grease a baking sheet with oil and spread coconut milk on the sticky rice.</li>
                        <li>3. Boil the water and simmer for about 45 minutes - 1 hour.</li>
                        <li>4.  Now clean and delicious, and it's not too sweet, so it tastes even better.</li>
