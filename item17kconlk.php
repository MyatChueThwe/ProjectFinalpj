...
<head>
    ...
    <h2 class="text-center m-4 course-p">Mont Pong(Steamed Rice Cake)</h2>
    
   <div class="info">
    <h3 class="text-success course-p">Ingredients</h3>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Glutinous rice flour - 2 tablespoons</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Salt - half a teaspoon</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Warm water - about 4 tablespoons</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Palm tree - 4 pieces</p>
    
</div>

    <!-- instruction section -->
    <div class="bg-kconlk-img-container">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card recipe-card p-4">
                <div class="card-body text-center">
                    <h2 class="card-title mb-3">Kaanhcwannu Nham Lone Kyaw</h2>
                    <hr class="my-4">
                    <h3 class="card-subtitle mb-4 ">Instructions</h3>
                    <ol class="list-unstyled text-start">
                        <li>1.Mix the glutinous rice flour, rice flour, and salt well.Add hot water one spoon at a time and knead.</li>
                        <li>2.Knead the rice flour into small pieces with your hands and filter it.</li>
                        <li>3.Sift the rice flour into a small bowl.For food, crush small stones and do not break them.</li>
                        <li>4..Lightly grease the mixing bowls. Add one tablespoon of the sifted flour first, then add one tablespoon of the flour that has been pounded with a palm.</li>
                        <li>5..Sprinkle about two tablespoons of flour on top to coat the food.Now add the powder one cup at a time until it is all dissolved,then simmer in boiling water for 10 minutes./li>
                    </ol>
                </div>
            </div>
        </div>
