...
<head>
    ...
    <!-- about section -->
    <div class="about">
    <h2 class="text-center course-p">About Us</h2>
     <p class="course-p  fs-5 text-center">Welcome to the Sweet World of Burmese Traditional Snacks.</p>
   </div>
   
   <!-- about second section -->
     
   <div class="abt-sec">
    <p class="course-p fs-5 text-center fst-italic p-3">What You'll Experience -  More Than Just Cooking</p>
    <div class="container">
     <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-2">

        <div class="col-lg-7">
            <div class="row abt-1">
            <img src="./img pj/about 1.jpg" alt="about" width="50%" height="100%">
        </div>
        <div class="row text-center">
            <h5 >Hands-On Learning</h5>
               <i class="bi bi-fork-knife fs-3"></i>
               <p >Learn every step from ingredient<br> selection to final preparation<br> by doing it yourself.</p>
        </div>
        ...
        <div class="col-lg-5 text-center">
            ...
            <div class="row">
                ...
                <p>Learn about the stories behind the snacks,<br> Burmese customs, and culture.</p>
            </div>
            <div class="row abt-2">
                <img src="./img pj/about 2.jpg" alt="about" width="30%" height="80%"> 
            </div>
   ...
   <h2 class="text-center course-p p-3">Our Instructors</h2>
   <div class="container-fluid">
    
     <div class="row row-cols-1 row-cols-lg-3 g-2 g-lg-3">
        
        <div class="col-lg-4">
            <div class="row text-center course-p p-2  m-4 p-3 instru-name-1"><h3>Mrs. Emili Htun</h3></div>
              <div class="row"><p>They have many years of experience <br>in making Burmese traditional snacks.</p></div>
              <div class="row"><p> And they are passionate about passing on <br>her family's secrets and traditional recipes<br> to the next generation.</p></div>
              <div class="row"><p>With their warm spirit and expertise, they <br>help every student feel at home and <br>learn  with confidence.</p></div>  
            </div>
            <div class="col-lg-3 instruct-1"><img src="./img pj/instructor 1.jpg" alt="about" width="100%" height="70%"></div>
            <div class="col-lg-3 instruct-2"><img src="./img pj/instructor 2.jpg" alt="about" width="100%" height="70%"></div>
            <div class="col-lg-2"><div class="row text-center course-p p-2  mt-5 instru-name-2"><h3>Mrs. Emili Htun</h3></div></div>
        </div>
         </div>
