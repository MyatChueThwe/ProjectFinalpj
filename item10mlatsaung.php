...
<head>
    ...
    <h2 class="text-center m-4 course-p">Mont let Soung</h2>
    
   <div class="info">
    <h3 class="text-success course-p">Ingredients</h3>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Mont let song phat -1 piece</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Palm kernel flour -400 grams</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Salt - half a teaspoon</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Coconut - 1 (juiced)</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Sugar - 1 mini pack</p>
    
</div>

    <!-- instruction section -->
    <div class="bg-mls-img-container">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card recipe-card p-4">
                <div class="card-body text-center">
                    <h2 class="card-title mb-3">Mont let Soung</h2>
                    <hr class="my-4">
                    <h3 class="card-subtitle mb-4 ">Instructions</h3>
                    <ol class="list-unstyled text-start">
                        <li>1.Soak prepared bread slices in water in a large pan.For the coconut milk cake, heat coconut milk and 1cup of sugar in a pan until the sugar melts.</li>
                        <li>2. Add a little salt and cool the coconut milk.Once cooled, combine about half of the cake mixture with the coconut milk in a bowl.</li>
                        <li>3.Add about a tablespoon of raw milk and ice cubes. </li>
                        <li>4.For those who like palm leaves with rice, simmer a little water in a pan over high heat until it's no longer thick.Add a little salt, then return it to a cup with palm syrup and let it cool.</li>
                        <li>5.Pour half of the remaining cake mixture into a glass, add the palm syrup, add ice cubes</li>
                    </ol>
                </div>
            </div>
        </div>
