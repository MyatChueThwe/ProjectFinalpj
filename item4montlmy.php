...
<head>
    ...
    <h2 class="text-center m-4 course-p">Mont  Lin Mayar</h2>
    
   <div class="info">
    <h3 class="text-success course-p">Ingredients</h3>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Rice flour - 450 grams</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Sesame powder - 50 grams</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Green gram flour - 25 grams</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Ginger juice - 1 tablespoon</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Quail eggs - 10</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Corn - 15 grams (boiled and set aside)</p>
    
</div>

    <!-- instruction section -->
    <div class="bg-montlmy-img-container">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card recipe-card p-4">
                <div class="card-body text-center">
                    <h2 class="card-title mb-3">Mont  Lin Mayar</h2>
                    <hr class="my-4">
                    <h3 class="card-subtitle mb-4 ">Instructions</h3>
                    <ol class="list-unstyled text-start">
                        <li>1.In a bowl, add the brown rice flour,brown glutinous rice flour, brown pea flour, salt, ginger juice, and water and mix well.</li>
                        <li>2.Then, let the dough marinate for about 2 hours.</li>
                        <li>3. Spray a little oil in the pan where the dough will be made. Then, pour the dough into the small cups. </li>
                        <li>4..Put a filling in each cup. Spray with oil. When the dough is light in color and cooked, take it out and put it on a plate.</li>
                    </ol>
                </div>
            </div>
        </div>
