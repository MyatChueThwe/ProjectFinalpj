...
<head>
    ...
    <h2 class="text-center m-4 course-p">Thar Khway Yai</h2>
    
   <div class="info">
    <h3 class="text-success course-p">Ingredients</h3>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Rice - measuring  3 cup</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>White sticky rice - measuring 1 cup</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Coconut milk - 500 ml</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Sugar or palm oil</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Salt - a half of table spoon</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Raw milk-  1 bottle</p>
    
</div>


    <!-- instruction section -->
    <div class="bg-tharky-img-container">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card recipe-card p-4">
                <div class="card-body text-center">
                    <h2 class="card-title mb-3">Thar Khway Yai</h2>
                    <hr class="my-4">
                    <h3 class="card-subtitle mb-4 ">Instructions</h3>
                    <ol class="list-unstyled text-start">
                        <li>1.Wash and soak the glutinous rice for about (4) hours.Cook and cool separately or mix together.</li>
                        <li>2.Then add coconut milk, sugar, salt and cook over low heat until the sugar dissolves. Place half of the mixture in a clean bowl.</li>
                        <li>3.Add the remaining coconut milk and stir in the rice flour. The rice grains should be broken into small pieces.</li>
                        <li>4..Then, pour as much as you want into a serving bowl and add a little coconut milk or raw milk. If you like it sweeter, sprinkle a little sugar.</li>
                    </ol>
                </div>
            </div>
        </div>
