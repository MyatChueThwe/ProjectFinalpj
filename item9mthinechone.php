...
<head>
    ...
    <h2 class="text-center m-4 course-p">Mont  Thine Chone</h2>
    
   <div class="info">
    <h3 class="text-success course-p">Ingredients</h3>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Flour -cup of good quality flour for making bread</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Egg - 2 eggs</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Butter - 2tablespoons </p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Oil- a little oil</p>
    
</div>

    <!-- instruction section -->
    <div class="bg-monttc-img-container">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card recipe-card p-4">
                <div class="card-body text-center">
                    <h2 class="card-title mb-3">Mont  Thine Chone</h2>
                    <hr class="my-4">
                    <h3 class="card-subtitle mb-4 ">Instructions</h3>
                    <ol class="list-unstyled text-start">
                        <li>1.Break 2 eggs into flour (1 cup of soup bowl)</li>
                        <li>2. Add 1.5 cups of cold water and a pinch of salt and mix well.Cover and let the dough rise for about half an hour.</li>
                        <li>3. Then reduce the heat and add the butter and oil, stirring occasionally, and then add the two dough balls in a round shape (use a non-stick pan).</li>
                        <li>4. When the bread is cooked on one side, flip it over and bake until it is golden brown. When both sides are cooked,  can take it out.</li>
