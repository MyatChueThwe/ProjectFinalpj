...
<head>
    ...
    <h2 class="text-center m-4 course-p">Mont Pyar Tha Let</h2>
    
   <div class="info">
    <h3 class="text-success course-p">Ingredients</h3>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Rice flour - 4.5 packets</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Baking soda - one and a half teaspoons</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Water - 1500 ml</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Salt - one teaspoon</p>
    <p class="text-success fs-5 fw-bold course-p"><i class="bi bi-check2-circle text-success"></i>Eggs - two (to be beaten and added just before making the dough)</p>
    
    
</div>

    <!-- instruction section -->
    <div class="bg-montptl-img-container">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card recipe-card p-4">
                <div class="card-body text-center">
                    <h2 class="card-title mb-3">Mont Pyar Tha Let</h2>
                    <hr class="my-4">
                    <h3 class="card-subtitle mb-4 ">Instructions</h3>
                    <ol class="list-unstyled text-start">
                        <li>1. Mix steps 1 to 4 and refrigerate for 4-5 hours before baking. Add two beaten eggs just before baking. </li>
                        <li>2. Boil the Chop the onion and mix it with the cooked beans. Add sesame seeds and salt as needed.</li>
                        <li>3.Make it in a regular frying pan at home, just wipe it with a little      oil.</li>
